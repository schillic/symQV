...
from quavl.lib.constants import zero, one
from quavl.lib.operations.state_decomposition import separate_kth_qbit_from_state, from_angles
from quavl.lib.parsing.open_qasm import read_from_qasm
from quavl.lib.utils.arithmetic import kron

teleportation_file = '../../../benchmarks/quavl/teleportv3.qasm'


def test_read_from_qasm():
    qc = read_from_qasm('../../../benchmarks/quavl/cx.qasm')
