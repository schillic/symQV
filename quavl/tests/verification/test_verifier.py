...
from quavl.lib.constants import zero, one, H_matrix, Rk_matrix
...
from quavl.lib.utils.helpers import identity_pad_gate
from quavl.lib.verification.verifier import verify, build_objective_function


def test_objective_function():
    qc_path = '../../../benchmarks/quavl/teleportv3.qasm'
    spec_path = '../../../benchmarks/quavl/specs/teleportv3.qspec'
...
def test_verify_qft():
    qc_path = '../../../benchmarks/quavl/qft2.qasm'
    spec_path = '../../../benchmarks/quavl/specs/qft.qspec'
